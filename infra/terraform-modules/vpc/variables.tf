...
# OPTIONAL: pin to specific AZs; if left empty we auto-detect AZs in the region
variable "azs" {
  description = "List of AZs to spread subnets across (leave empty to auto-detect)"
  type        = list(string)
  default     = []
}
